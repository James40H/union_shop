...
void main() {
  ...
  group('Main header', () {
    ...
    testWidgets('SalePage has Main header home button', (WidgetTester tester) async {
    ...
    testWidgets('SalePage has Main header Shop button', (WidgetTester tester) async {
     ...
     testWidgets('SalePage has Main header Print Shack button', (WidgetTester tester) async {
     ...
     testWidgets('SalePage has Main header Sale button', (WidgetTester tester) async {
    ...
    testWidgets('SalePage has a title', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: SalePage()));
  ...
  testWidgets('SalePage has 4 item image', (WidgetTester tester) async {
