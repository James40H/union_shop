...
class _ClothingCollectionPageState extends State<ClothingCollectionPage> {
  ...
  // simple filter categories for the UI
  final List<String> _filters = ['All', 'Hoodies', 'Jumpers', 'T-Shirts', 'Sale'];
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(children: [
                                ...
                                isMobile
                                    ? PopupMenuButton<String>(
                                        ...
                                        itemBuilder: (ctx) => const [
                                          ...
                                          PopupMenuItem(
                                              value: 'print_shack', child: Text('The Print Shack')),
          ...
          // Collection heading & filters area
          Container(
            color: Colors.white,
            child: Padding(
                  ...
                  LayoutBuilder(builder: (context, constraints) {
                    ...
                    final chips = Wrap(
                      ...
                      children: _filters.map((f) {
                        ...
                        return FilterChip(
                          ...
                          selectedColor: const Color(0xFF4d2963).withOpacity(0.15),
                          checkmarkColor: const Color(0xFF4d2963),
                          labelStyle: TextStyle(
                            color: selected ? const Color(0xFF4d2963) : Colors.black87,
                          ),
                        );
                      }).toList(),
                    );
                    ...
                    if (isMobile) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          // row with dropdown and a simple "Filters" label
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              TextButton.icon(
                                onPressed: () {
                                  // on mobile a "Filters" affordance could open a modal - for now toggle 'All' UI
                                  // keep as placeholder
                                },
                                icon: const Icon(Icons.filter_list, color: Colors.black54),
                                label: const Text('Filters', style: TextStyle(color: Colors.black54)),
              ...
              child: Column(
                children: [
                  ...
                  GridView.count(
                    ...
                    crossAxisCount: 3, // show 3 columns on wide screens
                    crossAxisSpacing: 6,
                    mainAxisSpacing: 6,
